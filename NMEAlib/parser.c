...
nmeaParserNODE nmeaParserNodeBuffer; // fixed buffer
char SentenceBuffer[128];    // fixed buffer big enough for all
unsigned char ParserBuffer[NMEA_MIN_PARSEBUFF];
/*
 * high level
 */
...
#else
    parser->buffer = ParserBuffer;
    parser->buff_size = NMEA_MIN_PARSEBUFF;
    resv = 1;
