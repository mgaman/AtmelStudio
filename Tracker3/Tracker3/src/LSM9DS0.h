...
#define LSM9DS0_G_SLAVE   ((0x35<<1) | SDO_G)
...
#if SDO_XM == 0
#define LSM9DS0_XM_SLAVE   0x1E
#else
#define LSM9DS0_XM_SLAVE   0x1D
#endif
...
#define LSM9DS0_POLL  // interrupts don't work when debugging
