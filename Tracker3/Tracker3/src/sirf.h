...
struct sMID136 {   // Mode control
  ...
  uint8_t PositionCalcMode; // described in Hornet OSF manual, not in SIRF manual
  uint8_t spare2;
  int16_t Altitude;
  uint8_t AltHoldMode;
...
// PositionCalcMode bit masks
#define ALMANAC_BASED_POSITIONING 0x01
#define REVERSE_EE_ENABLED 0x02
#define FIVE_HZ_NAV_ENABLED 0x04
#define SBAS_RANGING_ENABLED 0x08
#define FAST_TIME_SYNC 0x10
